...
namespace Keycloak.Ioc
{
	public class ServiceProvider
	{
		#region Constants

		private const string SERVICE_CONTRACTS_NAMESPACE = "Keycloak.Services.Interfaces";
		private const string SERVICE_IMPLEMENTATIONS_NAMESPACE = "Keycloak.Services";
		...
		{
			var allTypes = typeof(KeycloakServiceBase).Assembly.GetTypes();
